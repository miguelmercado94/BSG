...
Backend **Spring Boot** del proyecto DocViz — Sesión 1: Git/workspaces, chat RAG, área de trabajo S3, vector store **PostgreSQL/pgvector**. Perfil **local**: **Ollama**. Perfiles **develop/pdn**: chat **Groq** + embeddings **OpenAI** (Spring AI; mismo JAR / imagen Docker).

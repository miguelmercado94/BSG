CREATE OR REPLACE TRIGGER TRG_AUDIT_A5021104
BEFORE UPDATE OR INSERT OR DELETE ON A5021104
FOR EACH ROW
DECLARE

v_Tabla AUDIT_TESO.Tabla%TYPE := 'A5021104';
...
ELSE
	-- Si cambio de Estado_Transferencia buscar todas las ordenes de pago

CREATE OR REPLACE TRIGGER TRG_BIU_R_C2010804_TER
  BEFORE INSERT OR UPDATE OF COD_BENEF,TDOC_TERCERO,SEC_TERCERO ON C2010804
  FOR EACH ROW
DECLARE
...
ELSE
 ...
 BEGIN
     VSEC := NULL;
     PCK999_TERCEROS.PRC_DATOSD_TERCERO(VNRO,VTIPO,:NEW.SEC_TERCERO,V_PrimerA,
     V_SegundoA,V_PrimerN,V_SegundoN,V_Razon_Social,V_Tipo,V_DescTipo);
     :NEW.COD_BENEF := VNRO;

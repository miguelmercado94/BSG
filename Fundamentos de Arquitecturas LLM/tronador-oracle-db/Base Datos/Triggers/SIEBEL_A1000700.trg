CREATE OR REPLACE TRIGGER SIEBEL_A1000700
AFTER
INSERT or UPDATE or DELETE on a1000700
for each row
declare
   ...
   begin
     ...
     Exception
        when NO_CONEXION then
             ...
             values('Divisiones...Error al conectarse a Siebel',sysdate);
        when others then
             insert into conexion_tronsieb
             values('Divisiones...Error al insertar en Siebel',sysdate);
     end;
   Exception
      when NO_CONEXION then
           insert into conexion_tronsieb

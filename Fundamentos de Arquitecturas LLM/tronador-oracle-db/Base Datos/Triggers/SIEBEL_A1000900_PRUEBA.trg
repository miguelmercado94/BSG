CREATE OR REPLACE TRIGGER SIEBEL_A1000900_PRUEBA
AFTER
INSERT or UPDATE or DELETE ON A1000900_PRUEBA 
for each row
declare
...
wtabla		varchar2(20) := 'A1000900_PRUEBA';
   ...
   begin
     ...
     Exception
       when NO_CONEXION then
            ...
            values('Companias..Error al conectarse a Siebel',sysdate);
       when others then
            insert into conexion_tronsieb
            values('Companias..Error al insertar en Siebel',sysdate);
     end;
   Exception
      when NO_CONEXION then
            insert into conexion_tronsieb

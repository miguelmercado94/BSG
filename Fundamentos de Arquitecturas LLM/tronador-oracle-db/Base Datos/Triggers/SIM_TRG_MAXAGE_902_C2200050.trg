CREATE OR REPLACE TRIGGER SIM_TRG_MAXAGE_902_C2200050
...
WHEN ((
      ...
      AND NEW.cod_cob IN (902,915,903,918,905)
     ))

/*
Created by: Juan González
Date:07 11 2018
Porpouse: Guardar la edad máxima tabla parametro MAX_AGE_902

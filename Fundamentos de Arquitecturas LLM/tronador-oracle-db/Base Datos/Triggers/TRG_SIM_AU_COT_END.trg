CREATE OR REPLACE TRIGGER "SIM_TRG_AU_COT_END" BEFORE UPDATE OF "MCA_TERM_OK" ON "SIM_COTIZACION_ENDOSO" FOR EACH ROW
...
DECLARE
 ...
 CURSOR tipo_envio IS
   SELECT sim_tipo_envio, num_end FROM SIM_COTIZACION_ENDOSO

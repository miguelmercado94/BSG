CREATE OR REPLACE TRIGGER TR_BIUDR_CORRESPONSALORDEN
BEFORE
  UPDATE OR INSERT OR DELETE ON CORRESPONSALES_ORDENES_PAGO
  FOR EACH ROW
DECLARE
  v_tabla                 audit_teso.tabla%TYPE := 'CORRESPONSALES_ORDENES_PAGO';

CREATE OR REPLACE TRIGGER TR_AIUDR_SIMAPI_DEDUCIBLES_JN
  AFTER 
  INSERT OR 
  UPDATE OR 
  DELETE ON SIMAPI_DEDUCIBLES for each row
Declare 
  rec SIMAPI_DEDUCIBLES_JN%ROWTYPE; 
  blank SIMAPI_DEDUCIBLES_JN%ROWTYPE; 
  BEGIN 
    rec := blank; 
    ...
    END IF; 
    INSERT into SIMAPI_DEDUCIBLES_JN VALUES rec; 
  END;
/
